<template>
  ...
  >
    <div
      v-if="toast.show"
      :class="[
        'max-w-sm w-full backdrop-blur-xl border rounded-2xl shadow-2xl overflow-hidden',
    ...
    >
        <div class="p-4">
          <div class="flex items-start space-x-3">
            ...
            <button
              @click="close"
              class="flex-shrink-0 w-5 h-5 transition-colors text-gray-500 hover:text-white"
            >
        ...
        <!-- Progress Bar -->
        <div v-if="toast.duration" class="h-1 bg-white/5">
          <div
            class="h-full transition-all duration-300 ease-linear bg-violet-500"
