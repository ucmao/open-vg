<template>
  <div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        <h2 class="text-2xl font-bold text-gray-900">List</h2>
        ...
        <div class="overflow-x-auto">
          <table class="w-full min-w-max divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-if="loading">
                <td colspan="10" class="px-6 py-10 text-center text-gray-500">Loading......</td>
              </tr>
              <tr v-else-if="models.length === 0">
                <td colspan="10" class="px-6 py-10 text-center text-gray-500"></td>
              </tr>
              <tr 
              ...
              >
                ...
                <button @click="handleDuplicate(model)" class="text-green-600 hover:text-green-800"></button>
              ...
              <div class="space-y-6">
                ...
                <div class="pt-1">
                  <div class="flex items-center justify-between mb-2">
                    <h5 class="text-sm font-semibold text-gray-700 uppercase tracking-wide"></h5>
                    <NuxtLink
                  ...
                  <div class="min-h-[220px] max-h-[320px]">
                    <ClientOnly>
                      ...
                      <template #fallback>
                        <div class="min-h-[200px] flex items-center justify-center text-gray-400 text-sm">...</div>
                      </template>
                    </ClientOnly>
                  </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-4">
                  ...
                  >
                    <h5 class="text-sm font-bold text-gray-700"></h5>
                    <ChevronDown 
                        ...
                        <div class="grid grid-cols-2 gap-4 text-xs">
                          ...
                          <div class="space-y-3">
                            <div>
                              ...
                              <div v-else class="w-full aspect-[16/9] bg-gray-50 border border-dashed border-gray-200 rounded flex items-center justify-center text-gray-400 mb-2">
        ...
        <div class="flex-1 overflow-auto p-6">
          ...
          <div class="mt-4 p-3 bg-blue-50 rounded text-xs text-blue-700">
            ...
            <ul class="list-disc list-inside space-y-1">
              <li><code class="bg-blue-100 px-1 rounded">required</code>: true Required，RequiredSettings default </li>
              <li><code class="bg-blue-100 px-1 rounded">cost_additions</code>: （ <NuxtLink to="/models/pricing" class="text-blue-600 hover:underline"></NuxtLink> ）。/bool : {"5": 0, "8": 10}；int/float : "_ranges": [[min, max, ], ...]</li>
            </ul>
          </div>
        </div>
...
import { Plus, Search, X, Layers, ChevronsLeft, ChevronsRight, ChevronDown, ImageIcon } from 'lucide-vue-next'
