<template>
  <div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        <h2 class="text-2xl font-bold text-gray-900">{{ $adminT("List", "模型列表") }}</h2>
          ...
          <table class="w-full min-w-max divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr v-else-if="models.length === 0">
                <td colspan="10" class="px-6 py-10 text-center text-gray-500">{{ $adminT("Cannot initialise Evolution's mail component.", "暂无配置") }}</td>
              </tr>
              <tr 
            ...
            <div class="grid grid-cols-1 gap-6">
              ...
              <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                  <div>
                    <label class="block text-sm font-medium text-gray-700">{{ $adminT("Type", "任务类型") }} <span class="text-red-500">*</span></label>
                    <select
                  ...
                  <div>
                    ...
                    <div class="mt-1 flex items-center gap-2">
                      ...
                      >
                        <option :value="null">{{ $adminT("Type", "请先选择任务类型") }}</option>
                        <option 
                  ...
                  <div>
                    ...
                    <div class="mt-1 flex gap-2 items-center">
                      ...
                      <input
                        ...
                        type="url"
                        :placeholder="$adminT('_Other Organiser', 'https://... 或点击左侧从素材库选择')"
                ...
                <!-- ：Description  -->
                <div>
                  <label class="block text-sm font-medium text-gray-700">{{ $adminT("Description", "对外描述") }}</label>
                  <textarea
