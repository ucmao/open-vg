        ...
        <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4">
          <div class="flex items-center justify-between">
            <div class="flex">
              ...
              <div class="ml-3">
                <p class="text-sm text-blue-700"> {{ $adminT("Configures the s.txt content of the site. Leaves empty will use the default configuration generated by the system.", "配置网站的 robots.txt 内容。留空将使用系统生成的默认配置。") }} </p>
              </div>
            </div>
            <a
        ...
        <div class="bg-green-50 border-l-4 border-green-400 p-4 mb-4">
          <div class="flex items-center justify-between">
            <div class="flex">
              ...
              <div class="ml-3">
                <p class="text-sm text-green-700"> {{ $adminT("Select the resource type that you want to include in Sziap. The system is automatically generated based on the content of the database.", "选择要在 Sitemap 中包含的资源类型。系统会根据数据库内容自动生成。") }} </p>
              </div>
            </div>
            <a
            ...
            <div class="flex items-start justify-between mb-3">
              <div>
                ...
                <p v-if="config.config_key === 'sitemap_include_works'" class="text-xs text-amber-600 mt-2 flex items-center">
                  <Info class="w-3 h-3 mr-1" /> {{ $adminT("Note: Non-selection pages will be automatically set to no.11 to protect main station weights.", "注：非精选作品页面将自动设置为 noindex 以保护主站权重。") }} </p>
              </div>
            </div>
